...
public class Masina {
    ...
    public Masina(String marca, String model, int an, String cukoare, List<String> dotariInterioare, boolean electrica) {
        this.marca = marca;
        this.model = model;
        this.an = an;
        this.culoare = cukoare;
    ...
    public Masina(String model, String marca, int an, String culoare, List<String> dotariInterioare, boolean electrica, int pret) {
        this.model = model;
        this.marca = marca;
        this.an = an;
        ...
        if (dotariInterioare.isEmpty()) {
            ...
            for (int index=0; index<dotariInterioare.size(); index++){
                switch (dotariInterioare.get(index)){
                    case "Aer conditionart":
                        dotari=dotari + 1000;
                        break;
                    case "Incalzire in scaun":
                            dotari=dotari + 2000;
                            break;
